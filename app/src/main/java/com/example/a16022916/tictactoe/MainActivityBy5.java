...
//        newGame onRetainNonConfigurationInstance(true);
    ...
    public void gamePlay(int x, int y, ImageButton ib) {
        ...
        {
            Toast.makeText(MainActivityBy5.this, "Move not allowed!", Toast.LENGTH_SHORT).show();
        ...
        {
            Toast.makeText(MainActivityBy5.this, "Win", Toast.LENGTH_SHORT).show();
            if (newGame.getCurrentPiece() == Game.Piece.X)
            {
                pastMoves[x][y] = Game.Piece.X;
        ...
        {
            Toast.makeText(MainActivityBy5.this, "Draw", Toast.LENGTH_SHORT).show();
            if (newGame.getCurrentPiece() == Game.Piece.X)
            {
                pastMoves[x][y] = Game.Piece.X;
